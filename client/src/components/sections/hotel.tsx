    ...
    <section id="hotel" className="py-20 bg-white mt-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="max-w-3xl">
                ...
                <Link href="/contact">
                  <Button size="lg" className="bg-yellow-400 text-black hover:bg-yellow-300 font-bold">
                    <i className="fas fa-crown mr-2"></i> Reserve Your Palace Suite
                  </Button>
                </Link>
              </div>
            </div>
          ...
          <div className="bg-gradient-to-r from-red-900 to-purple-900 rounded-2xl p-8 md:p-12 text-white">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <Link href="/contact">
                  <Button size="lg" className="bg-white text-red-900 hover:bg-gray-100 font-bold">
                    <i className="fas fa-dice mr-2"></i> Book Casino Resort
                  </Button>
                </Link>
              </div>
          ...
          <div className="relative mb-12">
            ...
            <div className="absolute bottom-0 left-0 right-0 p-8 md:p-12 text-white">
              <div className="max-w-3xl">
                ...
                <p className="text-lg md:text-xl mb-6 text-white/90">
                  Imagine watching world-class artists perform on a floating stage while you relax in the crystal-clear waters of our artificial lagoon built with Crystal Lagoons technology. Bohemian luxury cabanas, beach bonfires, and unforgettable sunset experiences.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <Card className="overflow-hidden hover:shadow-2xl transition-shadow duration-300 group border-2 border-teal-100">
              ...
              <CardContent className="p-6">
                ...
                <p className="text-gray-600 mb-4">Step directly into the crystal waters from your private terrace with stunning floating stage views.</p>
            ...
            <Card className="overflow-hidden hover:shadow-2xl transition-shadow duration-300 group border-2 border-teal-100">
              ...
              <CardContent className="p-6">
                ...
                <p className="text-gray-600 mb-4">Nestled in tropical gardens with rooftop stargazing terrace and hammock lounge.</p>
                <ul className="space-y-2">
                  <li className="flex items-center text-sm text-gray-600">
            ...
            <Card className="overflow-hidden hover:shadow-2xl transition-shadow duration-300 group border-2 border-teal-100">
              <div className="relative overflow-hidden">
                <img 
                  ...
                  alt="Overwater Cabana"
                  className="w-full h-56 object-cover transition-transform duration-500 group-hover:scale-110"
                />
              </div>
              <CardContent className="p-6">
                <h4 className="text-xl font-serif font-bold text-primary mb-2">Overwater Suite</h4>
                <p className="text-gray-600 mb-4">Floating bungalow with glass floor viewing panels and private swim platform.</p>
                <ul className="space-y-2">
                  <li className="flex items-center text-sm text-gray-600">
          ...
          <div className="bg-gradient-to-r from-teal-50 to-cyan-50 rounded-2xl p-8">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              ...
              <div>
                ...
                <Link href="/contact">
                  <Button size="lg" className="bg-teal-600 text-white hover:bg-teal-700 font-bold">
                    <i className="fas fa-water mr-2"></i> Reserve Your Cabana
                  </Button>
                </Link>
              </div>
            </div>
        ...
        <div className="text-center mt-16">
          <p className="text-gray-600 mb-6 text-lg">Can't decide? Our concierge team will help you find your perfect stay.</p>
          <Link href="/contact">
            <Button size="lg" variant="outline" className="border-2 border-primary text-primary hover:bg-primary hover:text-white">
              <i className="fas fa-phone mr-2"></i> Contact Our Concierge
            </Button>
          </Link>
        </div>
      </div>
